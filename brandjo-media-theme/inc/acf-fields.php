            ...
            'sub_fields' => [
                ...
                [
                    ...
                    'sub_fields' => [
                        ...
                        [
                            'key' => 'brandjo_project_video_url',
                            'label' => 'YouTube Video URL',
                            'name' => 'video_url',
                            'type' => 'url',
                            'instructions' => 'Paste a YouTube video URL (e.g. https://www.youtube.com/watch?v=...) — leave empty if using file upload above.',
                        ],
                        [
            ...
            'sub_fields' => [
                ...
                [
                    ...
                    'sub_fields' => [
                        ...
                        [
                            'key' => 'brandjo_review_video_youtube_url',
                            'label' => 'YouTube Video URL',
                            'name' => 'youtube_url',
                            'type' => 'url',
                            'instructions' => 'Paste a YouTube video URL — leave empty if using file upload above.',
                        ],
                    ],
                ],
            ],
        ...
        [
            ...
            'sub_fields' => [
                [
                    ...
                    'name' => 'headline',
                    'type' => 'text',
                    'default_value' => 'Your Brand Deserves',
                ],
                [
                    'key' => 'brandjo_final_cta_headline_highlight',
                    'label' => 'Headline Highlight (gradient text)',
                    'name' => 'headline_highlight',
                    'type' => 'text',
                    'default_value' => 'More Attention.',
                ],
                [
